...
def graficar_resultados():
    ...
    plt.axhspan(170,180,facecolor='green',alpha=0.2,label="Perfecta")
    plt.axhspan(160,170,facecolor='lightgreen',alpha=0.2,label="Buena")
    plt.axhspan(150,160,facecolor='yellow',alpha=0.2,label="Regular")
    plt.axhspan(140,150,facecolor='orange',alpha=0.2,label="Mala")
    plt.axhspan(130,140,facecolor='red',alpha=0.2,label="Pésima")
    plt.axhspan(0,130,facecolor='purple',alpha=0.2,label="Postura crítica")
